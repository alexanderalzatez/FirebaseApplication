...
class CreateFragment : Fragment() {
    ...
    private fun saveImage() {
        ...
        val photoRef = storage.reference.child("usuarios").child(root.eId.text.toString())
    ...
    private fun saveUser(urlFoto: String) {
        val name = root.eName.text.toString()
        val id = root.eId.text.toString()
        val email = root.eMail.text.toString()

        val user = User(name, id, email, urlFoto)
